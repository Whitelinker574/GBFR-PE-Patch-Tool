...
test('gravity suppression can be enabled and restored while noclip remains unavailable', () => {
  ...
  assert.match(source, /gravityStatus\?\.available !== true[\s\S]*?setGravityEnabled\(true\)[\s\S]*?spatialGravityEnable/)
