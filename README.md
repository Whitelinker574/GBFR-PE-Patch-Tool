...
<p align="center">
  <a href="https://github.com/Whitelinker574/GBFR-PE-Patch-Tool/releases/latest"><strong>下载 v1.91.5</strong></a> ·
...
| 页面 | 可以做什么 | 操作要点 |
| --- | --- | --- |
| 配装预设（查看与写入） | 查看每个角色保存的武器、12 个因子、4 个技能和专精；写入自定义配装 | 选存档位 → 选角色 → 查看，或点右侧“编辑 [角色] 配装” → 选目标槽 |
...
| 召唤石添加 / 修改（存档） | 在已由游戏开放召唤系统的存档中新增或完整修改召唤石 | 工具不会替存档强开该系统；写后重新读取验证 |
...
| 存档还未开放召唤石或专精系统 | 工具不会代替游戏解锁系统；先在游戏中正常开放对应功能 |
