...
| --- | --- | --- | --- |
| `audit_sigil_tables.py` | Extracted DLC 2.0.2 sigil tables plus `internal/backend/data/sigils.json` | Updates or verifies `docs/evidence/sigil-table-audit-202.json` | After a game-table extraction or sigil-catalog change |
| `generate_ap_tree_panel_growth.py` | The local extracted table database and table directory | Rebuilds `internal/backend/data/ap_tree_panel_growth.json` with source checksums | After mastery, Fate, weapon-tree, or permanent-growth data changes |
